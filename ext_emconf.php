...
$EM_CONF[$_EXTKEY] = [
    ...
    'category' => 'plugin',
    'author' => 'Maximilian Fäßler, Steffen Kroggel, Christian Dilger, Philipp Grigoleit, Salih Özdemir',
    'author_email' => 'maximilian@faesslerweb.de, developer@steffenkroggel.de, c.dilger@addorange.de, p.grigoleit@agentur-fahrenheit.de, s.oezdemir@agentur-fahrenheit.de',
    'state' => 'stable',
    'internal' => '',
    'uploadfolder' => '0',
    'createDirs' => '',
